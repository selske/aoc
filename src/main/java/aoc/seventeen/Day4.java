...
public class Day4 {
    ...
    private static final String INPUT = "kvvfl kvvfl olud wjqsqa olud frc\n" + //
    ...
    public static void main(final String[] args) {
        System.out.println(countUnique(Function.identity()));
    ...
    private static long countUnique(final Function<String, String> mapper) {
        BufferedReader reader = new BufferedReader(new StringReader(INPUT));

        return reader.lines() //
                .filter(line -> {
                    String[] words = line.split(" ");
                    Set<Object> uniqueWords = Arrays.stream(words) //
                            .map(mapper::apply) //
